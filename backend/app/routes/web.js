...
router.get ('/admin/thread-list/', ThreadList.sendThreadLists)
...
router.post('/article-view/user-comment/edit/:id', UserComments.userEditComment)
router.post('/article-view/user-reply-comment/:id', UserComments.userReplyComment)
router.post('/article-view/user-delete-reply-comment/:id', UserComments.deleteReplyComment)
